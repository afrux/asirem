      ...
      return [
        <div className="Asirem-PermissionsPage-scopes">
          ...
          <div className="Asirem-PermissionsPage-scopes-controls">
            <Button className="Button" icon="fas fa-eye" onclick={() => (this.selectedScopes = Object.keys(scopes.items))}>
              Show All
            </Button>
            <Button className="Button" icon="fas fa-eye-slash" onclick={() => (this.selectedScopes = ['global'])}>
              Hide All
            </Button>
            <Dropdown
            ...
            >
              {Object.keys(scopes.items).map((key) => (
                <Button
                  ...
                  onclick={() => {
                    if (this.selectedScopes.includes(key)) this.selectedScopes = this.selectedScopes.filter((scope) => scope !== key);
                    else this.selectedScopes.push(key);
                  }}
                >
